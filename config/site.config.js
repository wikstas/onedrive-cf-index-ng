...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'RZH1225@outlook.com',
  ...
  googleFontSans: 'LXGW WenKai TC',
  // googleFontMono - the monospace font used in onedrive-cf-index-ng.
  googleFontMono: 'Fira Mono',
  // googleFontLinks -  an array of links for referencing the google font assets.
  googleFontLinks: ['https://fonts.googleapis.com/css2?family=LXGW+WenKai+TC:wght@700&display=swap'],
